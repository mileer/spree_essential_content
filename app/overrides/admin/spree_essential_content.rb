...
Deface::Override.new(:virtual_path => "spree/layouts/admin",
                     ...
                     :insert_after => "#admin_all_contents_sidebar_menu[data-hook]",
                     :partial => "admin/shared/contents_sub_menu",
                     :disabled => false)
...
# Deface::Override.new(:virtual_path  => "spree/admin/shared/all_contents_menu",
